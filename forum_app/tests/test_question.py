...
class AnswerTests(APITestCase):
   ...
   def setUp(self):
        self.admin = User.objects.create_superuser(username='testusers', password= 'testpasswords')

        self.client = APIClient()
        self.client.login(username='testusers', password= 'testpasswords')
        ...
        self.answer = Answer.objects.create(content= 'contentest', author = self.admin, question = self.question, created_at = datetime)
